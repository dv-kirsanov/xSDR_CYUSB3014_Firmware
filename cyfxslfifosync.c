        ...
        void)
{
    ...
    epCfg.burstLen = (usbSpeed == CY_U3P_SUPER_SPEED) ? (CY_FX_EP_BURST_LENGTH_U2P) : 1;
    epCfg.streams = 0;
    epCfg.pcktSize = size;
    ...
    epCfg.burstLen = (usbSpeed == CY_U3P_SUPER_SPEED) ? (CY_FX_EP_BURST_LENGTH_P2U) : 1;
    ...
    dmaCfg.size = (CY_FX_DMA_BUF_SIZE_U2P * CY_FX_EP_BURST_LENGTH_U2P);
    dmaCfg.size *= CY_FX_DMA_SIZE_MULTIPLIER_U2P;
    dmaCfg.count = CY_FX_DMA_BUF_COUNT_U2P;
    ...
    dmaCfg.size = (CY_FX_DMA_BUF_SIZE_P2U * CY_FX_EP_BURST_LENGTH_P2U);
    dmaCfg.size *= CY_FX_DMA_SIZE_MULTIPLIER_P2U;
    dmaCfg.count = CY_FX_DMA_BUF_COUNT_P2U;
